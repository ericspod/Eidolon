...
obj2 = SlicePlugin.createSliceBox(vec3(55.5,-25.0,24.5),vec3(25.0),(0, 0.33495133768504726, 0.22227234443175778))
mgr.addSceneObject(obj2)

rep3 = obj2.createRepr(ReprType._line)
mgr.addSceneObjectRepr(rep3)
mgr.showHandle(rep3,True)

obj2.setApplyToRepr(rep)
obj2.setApplyToRepr(rep1)
